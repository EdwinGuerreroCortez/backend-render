...
// Obtener la información de "Quiénes Somos"
quienesSomosRouter.get('/', async (req, res, next) => {
    const collection = req.db.collection("quienesSomos");
    try {
...
// Crear o actualizar la información de "Quiénes Somos"
quienesSomosRouter.post('/', async (req, res, next) => {
...
// Eliminar la información de "Quiénes Somos"
quienesSomosRouter.delete('/:id', async (req, res, next) => {
    const { id } = req.params;
...
// Actualizar la información de "Quiénes Somos"
quienesSomosRouter.patch('/:id', async (req, res, next) => {
    const { id } = req.params;
